...
import com.ruoyi.framework.shiro.web.filter.user.AjaxUserFilter;
...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filters.put("ajaxUser", ajaxUserFilter());
        // 注销成功，则跳转到指定页面
        filters.put("logout", logoutFilter());
        shiroFilterFactoryBean.setFilters(filters);

        // 所有请求需要认证
        filterChainDefinitionMap.put("/**", "ajaxUser,kickout,onlineSession,syncOnlineSession,csrfValidateFilter");
    ...
    public AjaxUserFilter ajaxUserFilter()
    {
        ...
        ajaxUserFilter.setLoginUrl(loginUrl);
